...
[\*\*[1]](https://github.com/code-423n4/2023-03-asymmetry/blob/main/contracts/SafEth/derivatives/Reth.sol#L173-L174) -\*_ \*\*`((((rethPerEth _ msg.value) / 10 ** 18) \* ((10 ** 18 - maxSlippage))) / 10 ** 18)`**
